...
// Pensez à ajouter un Else avec une redirection vers la page précedente pour dire que le champs n'est pas bon 
        ...
        <div class="col-10">
            ...
            <div id="corps">
                ...
                if ($resultsAdherent == 0){
                    ...
                    header("Location: VCIResa3.php?ID_FILM=$idFilm");
                    // mettre en place la redirection vers la page précédante en gardant en memoire le film sélectionné.
                }
                else{
                    $db=connectDb();
