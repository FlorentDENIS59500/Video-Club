...
$sqlRequest = "SELECT ID_FILM,TITRE_FILM,ANNEE_FILM,REF_IMAGE,NOM_STAR,PRENOM_STAR,LIB_TYPE_FILM "; 
$sqlRequest.= "FROM film JOIN star ON star.ID_Star=film.ID_REALIS JOIN typefilm ON typefilm.CODE_TYPE_FILM=film.CODE_TYPE_FILM ";
$sqlRequest.= "WHERE typefilm.CODE_TYPE_FILM ='".$idCatFilm."'";
